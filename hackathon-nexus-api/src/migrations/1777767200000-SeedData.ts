...
export class SeedData1777767200000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const firstNames = [
      ...
      "Xander", "Yuki", "Adrian", "Bianca", "Carlos", "Diana", "Ethan",
      "Fiona", "George", "Helena", "Ivan", "Julia", "Kevin", "Laura",
      "Marcus", "Nina", "Oscar", "Petra", "Ravi", "Sara", "Tom",
      "Ursula", "Victor", "Wanda", "Xerxes", "Yvonne", "Zane", "Arjun",
      "Beatrice", "Connor", "Daria", "Emil", "Fatima", "Gregor", "Hana",
      "Igor", "Jade", "Kai", "Lena", "Max", "Nadia", "Omar",
      "Priya", "Qian", "Rex", "Selena", "Theo", "Una", "Vito",
    ...
    const positionSkillSets: Record<string, { core: string[]; supplemental: string[] }> = {
      "Backend Developer": {
        core: ["Python", "Node.js", "Java", "Go", "PostgreSQL", "Redis", "Docker", "REST API Design", "Express.js", "FastAPI", "Django", "Spring Boot"],
        supplemental: ["TypeScript", "MongoDB", "Kubernetes", "gRPC", "AWS", "MySQL", "GraphQL", "Linux", "Git"],
      },
      "Frontend Developer": {
        core: ["JavaScript", "TypeScript", "React", "Vue.js", "Angular", "Tailwind CSS", "Next.js", "Svelte", "Figma"],
        supplemental: ["Node.js", "GraphQL", "REST API Design", "Git", "Unit Testing"],
      },
      "Full Stack Developer": {
        core: ["JavaScript", "TypeScript", "React", "Node.js", "PostgreSQL", "REST API Design", "Docker", "Next.js", "Express.js"],
      ...
      "Mobile Developer": {
        ...
        supplemental: ["TypeScript", "JavaScript", "REST API Design", "GraphQL", "Git", "Unit Testing", "Figma"],
      },
      "DevOps Engineer": {
        core: ["Docker", "Kubernetes", "AWS", "GCP", "Azure", "Linux", "Git"],
        supplemental: ["Python", "Go", "Rust", "PostgreSQL", "Redis", "Elasticsearch", "System Design"],
      },
      "Security Engineer": {
    ...
    const teamAdj = [
      "Agile", "Atomic", "Binary", "Bold", "Bright", "Chaotic", "Clever", "Cosmic",
      "Crafty", "Critical", "Cyber", "Dark", "Data", "Digital", "Dynamic", "Edge",
      "Elite", "Epic", "Fast", "Fuzzy", "Ghost", "Grand", "Green", "Hyper", "Indie",
      "Infinite", "Iron", "Kernel", "Laser", "Lean", "Logic", "Mega", "Micro", "Nano",
      "Neural", "Nimble", "Nova", "Open", "Optimal", "Pixel", "Prime", "Quantum",
      "Rapid", "Raw", "Root", "Rust", "Sharp", "Silent", "Sleek", "Smart", "Solid",
      "Sonic", "Stack", "Stealth", "Swift", "Tactical", "Turbo", "Ultra", "Vector",
      "Void", "Wild", "Zero",
    ];
    const teamNoun = [
      "Agents", "Aces", "Architects", "Array", "Bots", "Builders", "Bytes", "Clan",
      "Coders", "Collective", "Crafters", "Crew", "Crusaders", "Devs", "Drifters",
      "Dynamos", "Engineers", "Experts", "Force", "Forge", "Geeks", "Giants", "Grid",
      "Guardians", "Guild", "Hackers", "Heroes", "Hunters", "Labs", "League", "Legion",
      "Makers", "Minds", "Mavericks", "Ninjas", "Nodes", "Operators", "Pack",
      "Pioneers", "Pirates", "Protocol", "Rangers", "Rebels", "Runners", "Sages",
      "Shifters", "Signal", "Slayers", "Squad", "Stars", "Strike", "Surge", "Titans",
      "Troopers", "Unit", "Vanguard", "Warriors", "Wolves",
    ];
    ...
    for (let hIdx = 0; hIdx < hackathonIds.length; hIdx++) {
      ...
      const targetTotal = Math.round(capacity * (0.70 + Math.random() * 0.10));
      ...
      if (hackathonStarted) {
        ...
        while (inTeamCount < inTeamTarget && cursor < available.length) {
          ...
          const size = isFull
            ? maxTeamSize
            : randInt(1, maxTeamSize - 1);
          const slice: string[] = [];
          while (slice.length < size && cursor < available.length && inTeamCount + slice.length < inTeamTarget) {
        ...
        const soloPool = participantIds.filter((p) => !teamMembers.has(p) && !available.slice(0, cursor).includes(p));
