...
_METADATA = (
    ["participant", "skill", "hackathon", "team", "topic"],
    [
...
class TeamCompletionHGT(torch.nn.Module):
    def __init__(self, hidden_dim: int = 128, num_heads: int = 4, num_layers: int = 3, dropout: float = 0.25):
        super().__init__()
        ...
        self.convs = torch.nn.ModuleList([
            HGTConv(hidden_dim, hidden_dim, _METADATA, num_heads)
    ...
    def from_checkpoint(
        ...
        model = cls(hidden_dim, num_heads, num_layers, dropout)
